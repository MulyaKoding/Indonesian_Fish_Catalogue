...
class LocationSelectedAdapter(private val handler: (String, Int) -> Unit):
    RecyclerView.Adapter<LocationSelectedAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val item: String = this.items[position]
